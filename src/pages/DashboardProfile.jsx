...
export default function DashboardProfile() {
  ...
  const [prefs, setPrefs] = usePersistentState('profile-preferences', { dark: false, digest: true });
              ...
              <Card title="Photo de profil">
                <div className="flex flex-col items-center">
                  <div className="relative">
                    <img src={IMG.chef} alt="Marco" className="h-28 w-28 rounded-full object-cover"  decoding="async" loading="lazy" />
                    <button type="button" className="absolute bottom-0 right-0 flex h-8 w-8 items-center justify-center rounded-full bg-paper shadow"><CameraIcon className="h-4 w-4 text-ink" /></button>
                  </div>
