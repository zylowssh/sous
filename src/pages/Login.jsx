        ...
        <div className="flex flex-col px-6 py-8 sm:px-12 lg:px-16 lg:py-12">
          ...
          <div className="flex flex-1 items-center py-10">
            <Reveal className="w-full max-w-sm">
              ...
              <button type="button" className="mt-6 flex w-full items-center justify-center gap-2 rounded-sm border border-ink/20 bg-paper px-6 py-3.5 text-sm font-semibold text-ink transition-colors hover:border-ink">
        ...
        <div className="hidden flex-col justify-between border-l border-ink/10 px-10 py-10 lg:flex xl:px-16 xl:py-12">
          ...
          <Reveal delay={100} className="relative mt-8 flex-1">
            <div className="relative h-full min-h-[420px] overflow-hidden rounded-lg">
              <img src={IMG.interior} alt="Salle de restaurant" loading="lazy" className="h-full w-full object-cover"  decoding="async" />
            ...
            <div className="absolute -bottom-8 left-8 w-64 rounded-lg bg-paper p-5 shadow-photo">
              ...
              <button type="button" className="mt-4 flex w-full items-center justify-center gap-2 rounded-sm border border-ink/20 py-2.5 text-xs font-bold text-ink transition-colors hover:border-ink">
